...
$stmt = $conn->prepare("SELECT id, issue_type, subject, description, status, assignee, assigner, project, dateCreated, duedate FROM issues WHERE status = 'Open' " . $searchQuery . " ORDER BY " . $columnName . " " . $columnSortOrder . " LIMIT :limit, :offset");
