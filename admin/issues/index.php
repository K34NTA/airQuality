            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-flex justify-content-start mb-3 flex-wrap demo align-items-center">
                        <h1 class="h6 mb-1 mr-2">
                            <strong><span style="color: black;">Status:</span></strong>
                        </h1>
                        <div class="btn-group mr-1">
                            <button type="button" class="btn status-btn" data-status="all"><span style="color: black;">All</span></button>
                        </div>
                        <div class="btn-group mr-1">
                            <button type="button" class="btn status-btn" data-status="open"><span style="color: black;">Open</span></button>
                        </div>
                        <div class="btn-group mr-2">
                            <button type="button" class="btn status-btn" data-status="in progress"><span style="color: black;">In Progress</span></button>
                        </div>
                        <div class="btn-group mr-2">
                            <button type="button" class="btn status-btn" data-status="resolved"><span style="color: black;">Resolved</span></button>
                        </div>
                        <div class="btn-group mr-4">
                            <button type="button" class="btn status-btn" data-status="closed"><span style="color: black;">Closed</span></button>
                        </div>
                    </div>
                    <style>
                        .btn.active,
                        ...
                        <script>
                            ...
                            buttons.forEach(function(button) {
                                button.addEventListener('click', function() {
                                    ...
                                    // Build the URL based on the status value
                                    var url = '';
                                    if (status === 'all') {
                                        url = 'all.php';
                                    } else if (status === 'open') {
                        ...
                        <table>
                            <tr class="border-bottom-1">
                                    <!-- Category -->
                                        <td style="width: 400px;"><strong><span style="color: black; margin-right: 10px;">Project</span></strong></td>
                                ...
                                <!-- Assignee -->
                                <td style="width: 200px;"><strong><span style="color: black; margin-right: 10px;">Assignee</span></strong></td>
                                        <td>
                                            <?php
                                                // Execute the query
                                ...
                                <td><img src="https://cdn-icons-png.flaticon.com/512/32/32382.png" class="user-icon" style="max-width: 30px; height: 30px; margin-right: 5px;" alt="User with headphones - Free people icons" aria-hidden="false"></td>
                                    <td>    <button class="btn mr-5 btn-success" type="button">Go</button></td>
                            </tr>
                        </table>
                            ...
                            $(document).ready(function(){
                                var dataTable = $('#issuesTable').DataTable({
                                    ...
                                    'columns': [
                                        ...
                                        },
                                        {
                                            ...
                                            render: function (data) {
                                                if (data) {
                                                    ...
                                                    return '<span class="oblong-bg" style="font-size: 12px; background-color: ' + backgroundColor + ';">' + data + '</span>';
                                                } else {
                                                    return '';
                                                }
                                            },
                                        ...
                                        { data: 'assigner', className: 'text-center' },
                                        { data: 'project', className: 'text-center' },
